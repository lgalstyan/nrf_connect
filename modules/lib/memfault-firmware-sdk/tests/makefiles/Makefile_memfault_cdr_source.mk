SRC_FILES = \
  $(MFLT_COMPONENTS_DIR)/core/src/memfault_custom_data_recording.c \
...
TEST_SRC_FILES = \
  $(MFLT_TEST_SRC_DIR)/test_memfault_custom_data_recording.cpp \
  $(MOCK_AND_FAKE_SRC_FILES)

CPPUTEST_CPPFLAGS += -DMEMFAULT_CDR_ENABLE=1
